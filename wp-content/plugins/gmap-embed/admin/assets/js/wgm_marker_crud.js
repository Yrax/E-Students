(function ($) {
  $(function () {
    ...
    function wgm_vanish_marker(type = "new") {
      if (type === "new") {
        ...
        if (
          ...
          typeof wgm_existing_marker == "object"
        ) {
    ...
    function wpgmap_reset_marker_add_form() {
      $(
        "#wpgmap_marker_name,#wpgmap_marker_address,#wpgmap_marker_lat_lng,#wpgmap_marker_link"
      ).val("");
      ...
      function () {
        ...
        jQuery.post(ajaxurl, data, function (response) {
          ...
          if (!is_update) {
            ...
            current_map_infowindows[parseInt(response.marker_id)] =
              wgm_new_marker_infoindow;
          }
          wgm_new_marker = null;

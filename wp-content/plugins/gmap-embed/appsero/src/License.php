...
class License
{
            ...
            <div class="appsero-license-settings appsero-license-section">
                ...
                <div class="appsero-license-details">
                    <p>
                        ...
                        printf(
                            wp_kses(
                                $this->client->__trans('Activate <strong>%s</strong> by your license key to get professional support and automatic update from your WordPress dashboard.'),
                                array('strong' => array())
                            ),
                    ...
                    <form method="post" novalidate="novalidate" spellcheck="false">
                        ...
                        <input type="hidden" name="_nonce"
                            value="<?php echo esc_attr(wp_create_nonce($this->client->name)); ?>">
                        <div class="license-input-fields">
                            ...
                            <button type="submit" name="submit"
                                class="<?php echo esc_attr('deactive' === $action ? 'deactive-button' : ''); ?>">
    ...
    private function show_active_license_info($license)
    {
        ...
        <div class="active-license-info">
            <div class="single-license-info">
                <h3><?php echo esc_html($this->client->_etrans('Activations Remaining')); ?></h3>
                <?php if (empty($license['activation_limit'])) { ?>
                    <p><?php echo esc_html($this->client->_etrans('Unlimited')); ?></p>
                <?php } else { ?>
                    <p class="<?php echo esc_attr($license['remaining'] ? '' : 'occupied'); ?>">
                        <?php
                        printf(
                            esc_html($this->client->__trans('%1$d out of %2$d')),
                            intval($license['remaining']),
                            intval($license['activation_limit'])
                        );
                        ?>
                    </p>
                <?php } ?>
    ...
    private function show_license_page_card_header($license)
    {
        ...
        <div class="appsero-license-title">
            <svg enable-background="new 0 0 299.995 299.995" version="1.1" viewBox="0 0 300 300" xml:space="preserve"

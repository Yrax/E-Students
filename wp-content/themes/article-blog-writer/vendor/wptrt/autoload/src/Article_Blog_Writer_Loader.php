...
class Article_Blog_Writer_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function article_blog_writer_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function article_blog_writer_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function article_blog_writer_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function article_blog_writer_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->article_blog_writer_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function article_blog_writer_load( $class ) {

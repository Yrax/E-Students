...
class Article_Blog_Writer_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function article_blog_writer_loadClassLoader($class)
    {
    ...
    public static function article_blog_writer_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }

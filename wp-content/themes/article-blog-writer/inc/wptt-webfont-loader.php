...
if ( ! class_exists( 'Article_Blog_Writer_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Article_Blog_Writer_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'article_blog_writer_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function article_blog_writer_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Article_Blog_Writer_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'article_blog_writer_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function article_blog_writer_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Article_Blog_Writer_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
